...
#--------------------------------------------------------------
                if msg.text == "Mulai Kick":
                    print "Okeh"
                    _name = msg.text.replace("Mulai Kick","")
                    gs = client.getGroup(msg.to)
                    sendMessage(msg.to,"T e r k i c k - Maaf yah bukan bermaksud jahat , tetapi iseng doang ^_^ *By Helix*")
                    targets = []
                    for g in gs.members:
